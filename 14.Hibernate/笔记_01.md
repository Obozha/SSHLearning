...
- [Hibernate01](#hibernate01)
    - [Hibernate框架的学习路线](#hibernate框架的学习路线)
    - [CRM的案例](#crm的案例)
        - [CRM的概述 - 了解](#crm的概述---了解)
        - [CRM有哪些模块](#crm有哪些模块)
    - [Hibernate的框架的概述](#hibernate的框架的概述)
        - [框架的概述](#框架的概述)
        - [EE的经典三层架构](#ee的经典三层架构)
        - [Hibernate的概述](#hibernate的概述)
            - [什么是Hibernate](#什么是hibernate)
            - [为什么学Hibernate](#为什么学hibernate)
    - [Hibernate入门](#hibernate入门)
        - [1. 下载Hibernate的开发环境](#1-下载hibernate的开发环境)
        - [2. 解压Hibernate](#2-解压hibernate)
        - [3. 创建一个项目，引入jar包](#3-创建一个项目引入jar包)
        - [4. 创建表](#4-创建表)
        - [5. 创建实体类](#5-创建实体类)
        - [创建映射](#创建映射)
        - [创建一个Hibernate的核心配置文件](#创建一个hibernate的核心配置文件)
        - [编写测试代码](#编写测试代码)
    - [Hibernate的常见配置](#hibernate的常见配置)
        - [XML提示配置](#xml提示配置)
        - [Hibernate的映射配置](#hibernate的映射配置)
        - [Hibernate的核心配置 - 了解](#hibernate的核心配置---了解)
        - [核心的配置](#核心的配置)
